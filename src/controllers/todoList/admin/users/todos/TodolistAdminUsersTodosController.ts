...
import { patchtodoListAdminUsersUserIdTodos } from "../../../../../providers/patchtodoListAdminUsersUserIdTodos";
import { AdminAuth } from "../../../../../decorators/AdminAuth";
import { AdminPayload } from "../../../../../decorators/payload/AdminPayload";
import { gettodoListAdminUsersUserIdTodosTodoId } from "../../../../../providers/gettodoListAdminUsersUserIdTodosTodoId";
import { puttodoListAdminUsersUserIdTodosTodoId } from "../../../../../providers/puttodoListAdminUsersUserIdTodosTodoId";
import { deletetodoListAdminUsersUserIdTodosTodoId } from "../../../../../providers/deletetodoListAdminUsersUserIdTodosTodoId";
...
export class TodolistAdminUsersTodosController {
  ...
  public async index(
    ...
    try {
      return await patchtodoListAdminUsersUserIdTodos({
        admin,
        userId,
        body,
      });
  ...
  public async at(
    ...
    try {
      return await gettodoListAdminUsersUserIdTodosTodoId({
        admin,
        userId,
        todoId,
      });
  ...
  public async update(
    ...
    try {
      return await puttodoListAdminUsersUserIdTodosTodoId({
        admin,
        userId,
        todoId,
        body,
  ...
  public async erase(
    ...
    try {
      return await deletetodoListAdminUsersUserIdTodosTodoId({
        admin,
        userId,
        todoId,
      });
